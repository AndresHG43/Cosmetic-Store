package com.store.cosmetics.config;

import com.store.cosmetics.service.contract.ITokenService;
...
@Configuration
@EnableWebSecurity(debug = true) //@EnableWebSecurity(debug = true): Enable debug mode for development
